...
import com.tool.chien_file_manage.FileTXTActivity;
...
public class SimpleFileExplorerActivity extends AppCompatActivity implements ActivityListener{
    ...
    public void onFileSelect(FileModel fileModel) {
        if(fileModel.isSelected()){
            ...
            if(fileModel.getAbsolutePath().contains(".txt")){
                Intent intent = new Intent(this, FileTXTActivity.class);
                intent.putExtra("path", fileModel.getAbsolutePath());
                intent.putExtra("name", fileModel.fileName);
